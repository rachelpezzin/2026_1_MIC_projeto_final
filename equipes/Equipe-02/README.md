...
| Comunicação serial (UART): envia temperatura periodicamente | PENDENTE |
| Comunicação serial (UART): recebe comandos para alterar o setpoint | PENDENTE |
...
| Display local (LCD ou 7 segmentos) | 2 | Mostrar temperatura atual e setpoint em um display do kit, sem depender do terminal serial. | PENDENTE |
...
| Setpoint via botão físico | 1 | Permitir ajustar o setpoint usando botões do kit, com debounce implementado via interrupção. | PENDENTE |
